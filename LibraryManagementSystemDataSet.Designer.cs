...
namespace LibrarySystem {
    ...
    public partial class LibraryManagementSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BookRow AddBookRow(string Title, string Status, string Publisher, string Author, int Reserve, string Category) {
...
namespace LibrarySystem.LibraryManagementSystemDataSetTableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Book] WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ([Author] = @Original_Author) AND ((@IsNull_Reserve = 1 AND [Reserve] IS NULL) OR ([Reserve] = @Original_Reserve)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)))";
...
SELECT Id, Title, Status, Publisher, Author, Reserve, Category FROM Book WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Book] SET [Title] = @Title, [Status] = @Status, [Publisher] = @Publisher, [Author] = @Author, [Reserve] = @Reserve, [Category] = @Category WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ([Author] = @Original_Author) AND ((@IsNull_Reserve = 1 AND [Reserve] IS NULL) OR ([Reserve] = @Original_Reserve)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)));
SELECT Id, Title, Status, Publisher, Author, Reserve, Category FROM Book WHERE (Id = @Id)";
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_Status, string Original_Publisher, string Original_Author, global::System.Nullable<int> Original_Reserve, string Original_Category) {
            ...
            if ((Original_Reserve.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_Reserve.Value));
            }
            else {
        ...
        public virtual int Insert(string Title, string Status, string Publisher, string Author, global::System.Nullable<int> Reserve, string Category) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Status, string Publisher, string Author, global::System.Nullable<int> Reserve, string Category, int Original_Id, string Original_Title, string Original_Status, string Original_Publisher, string Original_Author, global::System.Nullable<int> Original_Reserve, string Original_Category, int Id) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
            ...
            if ((Original_Reserve.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_Reserve.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Status, string Publisher, string Author, global::System.Nullable<int> Reserve, string Category, int Original_Id, string Original_Title, string Original_Status, string Original_Publisher, string Original_Author, global::System.Nullable<int> Original_Reserve, string Original_Category) {
