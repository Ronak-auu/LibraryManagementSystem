...
namespace LibrarySystem.LibraryManagementSystemDataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Department] = @Original_Department) AND ([Semester] = @Original_Semester) AND ([College_id] = @Original_College_id) AND ([ContactNo] = @Original_ContactNo) AND ([Email] = @Original_Email) AND ((@IsNull_Birthdate = 1 AND [Birthdate] IS NULL) OR ([Birthdate] = @Original_Birthdate)))";
...
SELECT Id, Name, Department, Semester, College_id, ContactNo, Email, Birthdate FROM Student WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Department] = @Department, [Semester] = @Semester, [College_id] = @College_id, [ContactNo] = @ContactNo, [Email] = @Email, [Birthdate] = @Birthdate WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Department] = @Original_Department) AND ([Semester] = @Original_Semester) AND ([College_id] = @Original_College_id) AND ([ContactNo] = @Original_ContactNo) AND ([Email] = @Original_Email) AND ((@IsNull_Birthdate = 1 AND [Birthdate] IS NULL) OR ([Birthdate] = @Original_Birthdate)));
SELECT Id, Name, Department, Semester, College_id, ContactNo, Email, Birthdate FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LibrarySystem.Properties.Settings.Default.LibraryManagementSystemConnectionString;
        }
        ...
        public virtual int Fill(LibraryManagementSystemDataSet1.StudentDataTable dataTable) {
        ...
        public virtual LibraryManagementSystemDataSet1.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibraryManagementSystemDataSet1.StudentDataTable dataTable = new LibraryManagementSystemDataSet1.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibraryManagementSystemDataSet1.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Department, int Original_Semester, string Original_College_id, string Original_ContactNo, string Original_Email, string Original_Birthdate) {
        ...
        public virtual int Insert(string Name, string Department, int Semester, string College_id, string ContactNo, string Email, string Birthdate) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Department, int Semester, string College_id, string ContactNo, string Email, string Birthdate, int Original_Id, string Original_Name, string Original_Department, int Original_Semester, string Original_College_id, string Original_ContactNo, string Original_Email, string Original_Birthdate) {
